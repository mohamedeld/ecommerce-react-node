...
module.exports.createWithdraw = catchAsyncErrors(async (req, res, next) => {
  try {
...
module.exports.getAllWithdraws = catchAsyncErrors(async (req, res, next) => {
  try {
...
module.exports.updateWithdraws = catchAsyncErrors(async (req, res, next) => {
  try {
